...
def upgrade():
    ...
    op.create_geospatial_table(
        ...
        sa.Column(
            "country_names", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column(
            "label_point",
            Geometry(
    ...
    op.create_index(
        op.f("ix_osm_nodes_views_node_id"), "osm_nodes_views", ["node_id"], unique=False
    )
    op.create_geospatial_table(
        "osm_nodes",
    ...
    op.create_index(
        op.f("ix_osm_nodes_country_code"), "osm_nodes", ["country_code"], unique=False
    )
